...
public class LabirintoBuilder {
	...
	public LabirintoBuilder addStanzaIngresso(String nomeStanzaIngresso) {
		Stanza ingresso = new Stanza(nomeStanzaIngresso);
		this.labirinto.setStanzaIngresso(ingresso);
		this.aggiungiAMappaEAggiornaUltima(ingresso);
		return this;
	}
